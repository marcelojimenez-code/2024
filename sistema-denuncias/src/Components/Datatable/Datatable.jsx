  ...
  return (
    <div>
      ...
      <table className="responsive-table highlight">
       ...
       {/* Botón para derivar los elementos seleccionados */}
       <div className="center">
        <button className="waves-effect waves-light btn" onClick={handleDerivar}>
          Derivar
        </button>
      </div>
    </div>
